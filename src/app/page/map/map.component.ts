...
export class MapComponent implements OnInit, OnDestroy {
  ...
  private createStands(): void {
    const standsData = [
      {
        name: 'Empresa 1',
        standLogo: '../../../assets/stand1.png',
        floorLogo: '../../../assets/logo.png',
      },
      {
        name: 'Empresa 2',
        standLogo: '../../../assets/stand2.png',
        floorLogo: '../../../assets/logo_MD.png',
      },
      {
        name: 'Empresa 3',
        standLogo: '../../../assets/stand3.png',
        floorLogo: '../../../assets/logo.png',
      },
      {
        name: 'Empresa 4',
        standLogo: '../../../assets/stand4.png',
        floorLogo: '../../../assets/logo.png',
      },
      {
        name: 'Empresa 5',
        standLogo: '../../../assets/stand6.png',
        floorLogo: '../../../assets/logo.png',
      },
      {
        name: 'Empresa 6',
        standLogo: '../../../assets/stand7.png',
        floorLogo: '../../../assets/logo.png',
      },
      {
        name: 'Empresa 7',
        standLogo: '../../../assets/stand8.png',
        floorLogo: '../../../assets/logo.png',
      },
      //segunda linea de stands
      {
        name: 'Empresa 8',
        standLogo: '../../../assets/stand9.png',
        floorLogo: '../../../assets/logo.png',
      },
      {
        name: 'Empresa 9',
        standLogo: '../../../assets/stand10.png',
        floorLogo: '../../../assets/logo.png',
      },
      {
        name: 'Empresa 10',
  ...
  private createStandWithBase(
    ...
    const baseMaterial = new BABYLON.StandardMaterial(
      `${name}-baseMaterial`,
      this.scene
    );
    ...
    const stand = BABYLON.MeshBuilder.CreatePlane(
      `${name}-stand`,
      { width: 4, height: 6 },
      this.scene
    );
    ...
    const standMaterial = new BABYLON.StandardMaterial(
      `${name}-standMaterial`,
      this.scene
    );
    standMaterial.diffuseTexture = new BABYLON.Texture(
      standLogoUrl,
      this.scene
    );
    ...
    // Logo en el suelo
    const floorLogo = BABYLON.MeshBuilder.CreatePlane(
      `${name}-floorLogo`,
      { width: 4, height: 2 },
      this.scene
    );
    ...
    const floorLogoMaterial = new BABYLON.StandardMaterial(
      `${name}-floorLogoMaterial`,
      this.scene
    );
    floorLogoMaterial.diffuseTexture = new BABYLON.Texture(
      floorLogoUrl,
      this.scene
    );
