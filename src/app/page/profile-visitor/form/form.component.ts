...
export class FormComponent implements AfterViewInit {
  ...
  public EditorDni: any;
  /** Editor de CKEditor para el campo de información adicional */
  public EditorPhone: any;
  public EditorName: any;
  public EditorEmail: any;
  ...
  async loadEditor() {
    ...
    this.EditorName = ckeditor.default;
    this.EditorPhone = ckeditor.default;
    this.EditorDni = ckeditor.default;
    this.EditorEmail = ckeditor.default;
  ...
  submitForm() {
    if (this.activeForm.valid) {
      ...
      this.userService.addUserInformation(formData).subscribe({
        next: () => {
