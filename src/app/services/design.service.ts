 ...
 */
  addDesign(designData: FormData, id?: string): Observable<{ success: boolean; message: string; idDesign?: string }> {
    const url = id ? `${this.apiUrl}/addDesign/${id}` : `${this.apiUrl}/addDesign`;

    return this.http.post<{ message: string; idDesign: string }>(url, designData, { withCredentials: true }).pipe(
      map((response) => ({
        success: true,
      ...
      catchError((error) => {
        const errorMessage = error.error?.message || 'Error desconocido al agregar el diseño';
 ...
 */
  getDesign(id?: string): Observable<{ success: boolean; data?: any; message?: string }> {
    const url = id ? `${this.apiUrl}/getDesign/${id}` : `${this.apiUrl}/getDesign`;
    ...
    return this.http.get<any>(url, { withCredentials: true }).pipe(
      ...
      catchError((error) => {
        const errorMessage = error.error?.message || 'Error desconocido al obtener el diseño';
        return of({
          success: false,
   ...
   */
  getAllDesigns(): Observable<{ success: boolean; data?: any[]; message?: string }> {
    ...
    return this.http.get<any[]>(url, { withCredentials: true }).pipe(
      ...
      catchError((error) => {
        const errorMessage = error.error?.message || 'Error desconocido al obtener los diseños';
        return of({ success: false, message: errorMessage });
      })
    );
  }
 ...
 */
  updateDesign(designData: FormData, id?: string): Observable<{ success: boolean; updatedDesign?: any; message?: string }> {
    const url = id ? `${this.apiUrl}/updateDesign/${id}` : `${this.apiUrl}/updateDesign`;
    ...
    return this.http.put<any>(url, designData, { withCredentials: true }).pipe(
      ...
      catchError((error) => {
        const errorMessage = error.error?.message || 'Error desconocido al actualizar el diseño';
        return of({ success: false, message: errorMessage });
      })
    );
  }
 ...
 */
  deleteDesign(id: string): Observable<{ success: boolean; message?: string }> {
    ...
    return this.http.delete<{ message: string }>(url, { withCredentials: true }).pipe(
      ...
      catchError((error) => {
        const errorMessage = error.error?.message || 'Error desconocido al eliminar el diseño';
        return of({ success: false, message: errorMessage });
      })
    );
  }
 ...
 */
  getAllStands(): Observable<{ success: boolean; data?: any; message?: string }> {
    ...
    return this.http.get<any>(url).pipe(
      ...
      catchError((error) => {
        const errorMessage = error.error?.message || 'Error desconocido al obtener los stands';
        return of({
          success: false,
          message: errorMessage,
        });
 ...
 */
  getAllModels(): Observable<{ success: boolean; data?: any; message?: string }> {
    ...
    return this.http.get<any>(url).pipe(
      ...
      catchError((error) => {
        const errorMessage = error.error?.message || 'Error desconocido al obtener los modelos';
        return of({
          success: false,
          message: errorMessage,
        });
